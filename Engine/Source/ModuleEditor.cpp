...
ModuleEditor::ModuleEditor()
{
    ...
    editorPanels.push_back(inspector = new InspectorPanel());
...
update_status ModuleEditor::Update()
{
    ...
    //Move to a custom Panel??? Or delete
    if(demo)
...
void ModuleEditor::embraceTheDarkness() const
{
    ...
    colors[ImGuiCol_Separator] = ImVec4(0.48f, 0.48f, 0.48f, 0.49f);
